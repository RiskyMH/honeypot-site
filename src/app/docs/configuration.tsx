...
function RouteComponent() {
  return <DocsLayout>
    ...
    <DocsSection title="/honeypot modal">
      ...
      <DocsP>Optional switches for extra behavior. Most can be enabled together.</DocsP>
      <DocsTable
      ...
      />
      <DocsP><strong>Legend:</strong> 💡 recommended features · ⚙️ advanced, only use if you're seeing issues (may need 1+ bans to see)</DocsP>
